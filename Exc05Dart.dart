// No país de Cotemigos a moeda nacional é a merreca (M$). Sabe-se que sistema
...
void main()
{
  ...
  if (merreca%100 != 0)
  {
    ...
    print(num.toString()+ " moeda(s) de M 100,00");
    merreca = merreca - (num * 100);
  }
  if (merreca%50 != 0)
  {
    num = (merreca/50).toInt();
    print(num.toString()+ " moeda(s) de M 50,00");
    merreca = merreca - (num * 50);
  }
   if (merreca%10 != 0)
  {
    num = (merreca/10).toInt();
    print(num.toString()+ " moeda(s) de M 10,00");
    merreca = merreca - (num * 10);
  }
  if (merreca%5 != 0)
  {
    num = (merreca/5).toInt();
    print(num.toString()+ " moeda(s) de M 5,00");
    merreca = merreca - (num * 5);
  }
  if (merreca%5 != 0)
  {
    num = (merreca/1).toInt();
    print(num.toString()+ " moeda(s) de M 1,00");
